function getIconSrc(description) {
    const iconMap = {
        ...
        'Heavy rain': './weatherIcons/sunny-sunny.png',  // Is this intentional? Usually heavy rain is not sunny.
    ...
    return iconMap[description] || './weatherIcons/default.png'; // fallback icon if no match
}
